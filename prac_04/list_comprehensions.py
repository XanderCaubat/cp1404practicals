...
List comprehensions
This program display a list of names.
"""
...
# list comprehension to create a list of integers from a list of strings below
almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
numbers = [int(number) for number in almost_numbers]
print(numbers)

# a list of numbers greater than 9 from the numbers list8
